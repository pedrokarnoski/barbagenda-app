...
import { Check, Scissors, X as RemoveIcon } from 'lucide-react'
import React, {
  createContext,
  forwardRef,
  KeyboardEvent,
...
>(({ className, children, ...props }, ref) => {
  ...
  return (
    <div
      ...
      {...props}
    >
      <Scissors className="ml-3 h-4 w-4 text-primary" />
...
>(({ className, ...props }, ref) => {
  ...
  return (
    <CommandPrimitive.Input
      ...
      className={cn(
        'ml-1 flex-1 bg-transparent outline-none placeholder:text-muted-foreground',
        className,
...
>(({ className, children }, ref) => {
  return (
    ...
    >
      {children}
      <CommandEmpty>
        <span className="text-muted-foreground">Nenhum serviço encontrado</span>
      </CommandEmpty>
    </CommandList>
  )
})
...
>(({ className, value, children, ...props }, ref) => {
  ...
  return (
    <CommandItem
      ...
      className={cn(
        'flex cursor-pointer gap-2 rounded-md px-2 py-2 transition-colors ',
        className,
